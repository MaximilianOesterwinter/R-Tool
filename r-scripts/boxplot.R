...
plot <- ggplot(df, aes(y=.data[[var1]])) + 
...
plot_path <- file.path(output_dir, paste0("boxplot_", var1, ".png"))
report_file <- file.path(output_dir, paste0("boxplot_", var1, ".pdf"))
...
rmarkdown::render(
  ...
  params = list(
    plot_title = paste("Boxplot of", var1),
